...
1.  Open an issue describing the policy-analysis need and intended
    users.
...
New exported functions require Roxygen documentation, examples, and
tests. New analytical rules require a citation or an explicit
methodological rationale. Changes to the Shiny app should include a
smoke-test update and browser review.
